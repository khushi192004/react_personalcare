...
const CategoryProducts = () => {
  ...
  return (
    <>
        ...
        >
          <div>
            ...
            <ol className="breadcrumb cs_fs_18 mb-0">
              ...
              <li className="breadcrumb-item active">CategoryProduct</li>
            </ol>
          </div>
        </div>
      </div>
      {/* End Breadcamp */}
      {/* Start All Products  */}
      {/* <button className="cs_drawer_btn cs_accent_bg">
        <svg
          width={17}
          height={32}
          viewBox="0 0 17 32"
      ...
      <div className="cs_overlay_filter_widgets">
        <div className="cs_overlay_filter" />
        <div className="cs_filter_widgets">
          <div className="cs_drower_logo">
            <img src="assets/images/drower_logo.svg" alt="Logo" />
          </div>
          <div className="cs_filter_widget">
            <h3 className="cs_filter_widget_title cs_fs_18 cs_normal cs_secondary_font">
              ...
              <ul className="cs_filter_widget_list cs_mp_0">
                <li>
                  <div className="cs_custom_checkbox">
                    <input type="checkbox" />
                    <span>
                      <span className="cs_rating" data-rating={5}>
                ...
                <li>
                  <div className="cs_custom_checkbox">
                    <input type="checkbox" />
                    <span>
                      <span className="cs_rating" data-rating={4}>
                        <span className="cs_rating_percentage" />
                      </span>
                    </span>
                  </div>
                ...
                <li>
                  <div className="cs_custom_checkbox">
                    <input type="checkbox" />
                    <span>
                      <span className="cs_rating" data-rating={3}>
                        <span className="cs_rating_percentage" />
                      </span>
                    </span>
                  </div>
                ...
                <li>
                  <div className="cs_custom_checkbox">
                    <input type="checkbox" />
                    <span>
                      <span className="cs_rating" data-rating={2}>
                        <span className="cs_rating_percentage" />
                      </span>
                    </span>
                  </div>
                ...
                <li>
                  <div className="cs_custom_checkbox">
                    <input type="checkbox" />
                    <span>
                      <span className="cs_rating" data-rating={1}>
                        <span className="cs_rating_percentage" />
                      </span>
                    </span>
                  </div>
